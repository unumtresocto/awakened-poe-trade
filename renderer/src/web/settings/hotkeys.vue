<template>
  <div class="max-w-md p-2">
    ...
    <div class="mb-8 flex">
      <label class="flex-1">{{ t("settings.alt_crafting") }}</label>
    </div>
    <div class="mb-8 flex">
...
const hotkeys = computed<HotkeySchema[]>(() => {
  ...
  const altCraftingWidget = findWidget<AltCraftingWidget>(
    "alt-crafting",
    props.config,
  )!;
  return [
    ...
    {
      translationKey: "alt_crafting",
      config: _configModelValue(altCraftingWidget, "hotkey"),
    },
  ];
});
