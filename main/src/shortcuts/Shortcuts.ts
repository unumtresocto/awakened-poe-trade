        ...
        () => {
          ...
          if (entry.action.type === "toggle-overlay") {
            ...
            this.ocrWorker
              ...
              .catch(() => {});
          } else if (entry.action.type === "alt-crafting") {
            if (entry.action.stop) {
              stopCrafting();
            } else {
              startCrafting(this.clipboard, this.gameConfig);
            }
          }
        },
      );
...
export function pressKeysToCopyItemText(
